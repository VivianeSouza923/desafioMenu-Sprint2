    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
              ...
              body: ScrollbarTheme(
                data: ScrollbarThemeData(
                  thumbColor: MaterialStateProperty.all<Color>(
                      const Color(0xffFFB987)), // Cor do polegar da barra de rolagem
                ),
                child: Container(
                  width: 5,
                  height: 200,
                  margin:
                      const EdgeInsets.only(top: 25.0, left: 16.0), // Posicionamento

                  child: Scrollbar(
                    thumbVisibility: true, // Mostrar a barra de rolagem sempre
                    thickness: 6.0, // Espessura da barra de rolagem
                    radius: const Radius.circular(
                        8.0), // Raio do polegar da barra de rolagem
          ...
          Padding(
            padding: const EdgeInsets.only(top: 32.0, left: 24, right: 24, bottom: 24),
            child: Container(
              height: 48,
              width: 342,
